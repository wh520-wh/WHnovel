...
def test_generate_chat_image_generic_error_on_failure():
    ...
    with patch.object(chat_router, "_get_or_create_app_settings") as mock_app, \
         ...
         patch.object(chat_router, "generate_chat_image", side_effect=RuntimeError("secret_internal_detail")):
