...
def _write_seed_flag(story_count: int) -> None:
    ...
    SEED_FLAG_FILE.write_text(
        json.dumps({"timestamp": datetime.now().isoformat(), "story_count": story_count}, ensure_ascii=False),
        encoding="utf-8",
    )
...
SAMPLE_STORIES = [
    {
        ...
        'state_config': [
            {'key': '好感度', 'label': '好感度', 'type': 'number', 'default': 30, 'max': 100, 'min': 0},
            {'key': '亲密度', 'label': '亲密度', 'type': 'number', 'default': 10, 'max': 100, 'min': 0},
            {'key': '信任值', 'label': '信任值', 'type': 'number', 'default': 50, 'max': 100, 'min': 0},
    ...
    },
    {
        ...
        'state_config': [
            {'key': 'HP', 'label': '生命值', 'type': 'number', 'default': 100, 'max': 100, 'min': 0},
            {'key': 'MP', 'label': '魔力值', 'type': 'number', 'default': 50, 'max': 100, 'min': 0},
            {'key': '金币', 'label': '金币', 'type': 'number', 'default': 100, 'max': 9999, 'min': 0},
    ...
    },
    {
        ...
        'state_config': [
            {'key': '线索数', 'label': '已收集线索', 'type': 'number', 'default': 0, 'max': 20, 'min': 0},
            {'key': '信任度', 'label': '嫌疑人信任度', 'type': 'number', 'default': 50, 'max': 100, 'min': 0},
            {'key': '真相进度', 'label': '真相接近度', 'type': 'number', 'default': 0, 'max': 100, 'min': 0},
    ...
    },
    {
        ...
        'state_config': [
            {'key': '星币', 'label': '星币', 'type': 'number', 'default': 1000, 'max': 99999, 'min': 0},
